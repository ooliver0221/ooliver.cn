...
export const layouts: Record<string, ResponsiveLayouts> = {
  ...
  projects: {
    ...
    sm: [
      ...
      { i: "miniModel", x: 1, y: 4, w: 1, h: 1 },
      { i: "themeSwitch", x: 1, y: 8, w: 1, h: 1 },
